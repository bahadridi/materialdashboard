...
function TagComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵattribute("contenteditable", ctx_r12.editing);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(3, _c1, ctx_r12.model, ctx_r12.index))("ngTemplateOutlet", ctx_r12.template);
} }
function TagComponent_div_2_delete_icon_3_Template(rf, ctx) { if (rf & 1) {
    const _r18 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "delete-icon", 8);
    ɵngcc0.ɵɵlistener("click", function TagComponent_div_2_delete_icon_3_Template_delete_icon_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r18); const ctx_r17 = ɵngcc0.ɵɵnextContext(2); return ctx_r17.remove($event); });
    ɵngcc0.ɵɵelementEnd();
} }
function TagComponent_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown.enter", function TagComponent_div_2_Template_div_keydown_enter_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r20); const ctx_r19 = ɵngcc0.ɵɵnextContext(); return ctx_r19.disableEditMode($event); })("keydown.escape", function TagComponent_div_2_Template_div_keydown_escape_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r20); const ctx_r21 = ɵngcc0.ɵɵnextContext(); return ctx_r21.disableEditMode($event); })("click", function TagComponent_div_2_Template_div_click_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r20); const ctx_r22 = ɵngcc0.ɵɵnextContext(); return ctx_r22.editing ? $event.stopPropagation() : undefined; })("blur", function TagComponent_div_2_Template_div_blur_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r20); const ctx_r23 = ɵngcc0.ɵɵnextContext(); return ctx_r23.onBlurred($event); });
    ɵngcc0.ɵɵtext(2);
    ɵngcc0.ɵɵelementEnd();
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵattribute("contenteditable", ctx_r13.editing)("title", ctx_r13.getDisplayValue(ctx_r13.model));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate1(" ", ctx_r13.getDisplayValue(ctx_r13.model), " ");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r13.isDeleteIconVisible());
} }
function TagComponent_tag_ripple_3_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "tag-ripple", 9);
} if (rf & 2) {
    const ctx_r14 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("state", ctx_r14.rippleState);
...
function TagInputDropdown_ng2_menu_item_2_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("innerHTML", ɵngcc0.ɵɵpipeBind2(1, 1, item_r25[ctx_r28.displayBy], ctx_r28.tagInput.inputForm.value.value), ɵngcc0.ɵɵsanitizeHtml);
} }
...
function TagInputDropdown_ng2_menu_item_2_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r25 = ctx_r32.$implicit;
    const index_r26 = ctx_r32.index;
    const last_r27 = ctx_r32.last;
    const ctx_r29 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r29.templates.first)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction3(2, _c2, item_r25, index_r26, last_r27));
} }
function TagInputDropdown_ng2_menu_item_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("value", item_r25)("ngSwitch", !!ctx_r24.templates.length);
    ɵngcc0.ɵɵadvance(1);
...
function TagInputComponent_tag_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onSelect", function TagInputComponent_tag_2_Template_tag_onSelect_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r39); const item_r36 = ctx.$implicit; const ctx_r38 = ɵngcc0.ɵɵnextContext(); return ctx_r38.selectItem(item_r36); })("onRemove", function TagInputComponent_tag_2_Template_tag_onRemove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r39); const item_r36 = ctx.$implicit; const i_r37 = ctx.index; const ctx_r40 = ɵngcc0.ɵɵnextContext(); return ctx_r40.onRemoveRequested(item_r36, i_r37); })("onKeyDown", function TagInputComponent_tag_2_Template_tag_onKeyDown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r39); const ctx_r41 = ɵngcc0.ɵɵnextContext(); return ctx_r41.handleKeydown($event); })("onTagEdited", function TagInputComponent_tag_2_Template_tag_onTagEdited_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r39); const ctx_r42 = ɵngcc0.ɵɵnextContext(); return ctx_r42.updateEditedTag($event); })("onBlur", function TagInputComponent_tag_2_Template_tag_onBlur_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r39); const i_r37 = ctx.index; const ctx_r43 = ɵngcc0.ɵɵnextContext(); return ctx_r43.onTagBlurred($event, i_r37); })("dragstart", function TagInputComponent_tag_2_Template_tag_dragstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r39); const item_r36 = ctx.$implicit; const i_r37 = ctx.index; const ctx_r44 = ɵngcc0.ɵɵnextContext(); return ctx_r44.dragZone ? ctx_r44.onDragStarted($event, item_r36, i_r37) : undefined; })("drop", function TagInputComponent_tag_2_Template_tag_drop_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r39); const i_r37 = ctx.index; const ctx_r45 = ɵngcc0.ɵɵnextContext(); return ctx_r45.dragZone ? ctx_r45.onTagDropped($event, i_r37) : undefined; })("dragenter", function TagInputComponent_tag_2_Template_tag_dragenter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r39); const ctx_r46 = ɵngcc0.ɵɵnextContext(); return ctx_r46.dragZone ? ctx_r46.onDragOver($event) : undefined; })("dragover", function TagInputComponent_tag_2_Template_tag_dragover_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r39); const i_r37 = ctx.index; const ctx_r47 = ɵngcc0.ɵɵnextContext(); return ctx_r47.dragZone ? ctx_r47.onDragOver($event, i_r37) : undefined; })("dragleave", function TagInputComponent_tag_2_Template_tag_dragleave_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r39); const ctx_r48 = ɵngcc0.ɵɵnextContext(); return ctx_r48.dragZone ? ctx_r48.dragProvider.onDragEnd() : undefined; });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const item_r36 = ctx.$implicit;
    const i_r37 = ctx.index;
    const ctx_r33 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵpropertyInterpolate("draggable", ctx_r33.editable);
    ɵngcc0.ɵɵproperty("canAddTag", ctx_r33.isTagValid)("disabled", ctx_r33.disable)("@animation", ctx_r33.animationMetadata)("hasRipple", ctx_r33.ripple)("index", i_r37)("removable", ctx_r33.removable)("editable", ctx_r33.editable)("displayBy", ctx_r33.displayBy)("identifyBy", ctx_r33.identifyBy)("template", !!ctx_r33.hasCustomTemplate() ? ctx_r33.templates.first : undefined)("draggable", ctx_r33.dragZone)("model", item_r36);
...
function TagInputComponent_div_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngClass", ctx_r35.theme);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r35.errors);
} }
const _c3 = ["*"];
